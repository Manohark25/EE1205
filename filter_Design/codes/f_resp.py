...
# Given parameters
epsilons = [0.306, 0.4, 0.5, 0.61]

# Read precomputed values of C_N from file
cn_values = np.loadtxt("cn_values.dat")
...
plt.legend(loc='best', title='Passband and Stopband', labels=['Epsilon = 0.306', 'Epsilon = 0.4', 'Epsilon = 0.5', 'Epsilon = 0.61', 'Passband', 'Stopband'])
plt.grid(True)
#plt.show()
plt.savefig("f_resp.png")
