...
\title{}
\author{EE23BTECH11208 - K.Manohar \par Audio Filtering
}
\maketitle
...
\begin{lstlisting}
https://github.com/Manohark25/EE1205/blob/main/audio_Filtering/codes/My_song.wav
\end{lstlisting}
...
\\
\solution The darker areas are those where the frequen-
cies have very low intensities, and the orange
and yellow areas represent frequencies that
have high intensities in the sound.\\
\newpage
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\columnwidth]{figs/original.png}
...
\\
\solution the signal is blank for frequencies above 1 kHz.
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.85\columnwidth]{figs/filtered.png}
...
\begin{lstlisting}
https://github.com/Manohark25/EE1205/blob/main/audio_Filtering/codes/3.2.c
\end{lstlisting} 
The following code plots \eqref{prob:2.1} and \eqref{prob:2.2}
\begin{lstlisting}
https://github.com/Manohark25/EE1205/blob/main/audio_Filtering/codes/3.2.py
\end{lstlisting}
\newpage
\begin{figure}[htbp]
	\centering
...
\begin{lstlisting}
https://github.com/Manohark25/EE1205/blob/main/audio_Filtering/codes/4.5.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Manohark25/EE1205/blob/main/audio_Filtering/codes/5.2.py
\end{lstlisting}
\begin{figure}[htbp]
\centering
...
\begin{lstlisting}
https://github.com/Manohark25/EE1205/blob/main/audio_Filtering/codes/5.4.py
\end{lstlisting}
\begin{figure}[htbp]
\centering
...
%
\begin{lstlisting}
https://github.com/Manohark25/EE1205/blob/main/audio_Filtering/codes/5.5.py
\end{lstlisting}
\begin{figure}[htbp]
\centering
...
\begin{lstlisting}
https://github.com/Manohark25/EE1205/blob/main/audio_Filtering/codes/6_sol.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Manohark25/EE1205/blob/main/audio_Filtering/codes/6.4.py  
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Manohark25/EE1205/blob/main/audio_Filtering/codes/6.5.py
\end{lstlisting}
\begin{figure}[htbp]
\centering
...
\begin{lstlisting}
https://github.com/Manohark25/EE1205/blob/main/audio_Filtering/codes/7.1.py
\end{lstlisting}
\begin{figure}[htbp]
\centering
...
\begin{lstlisting}
https://github.com/Manohark25/EE1205/blob/main/audio_Filtering/codes/7.2.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Manohark25/EE1205/blob/main/audio_Filtering/codes/7_filter_response.py
\end{lstlisting}
\begin{figure}[htbp]
\centering
...
\\
\solution The given butterworth filter is lowpass with order=4 and cutoff-frequency=1 		 	kHz.
\bigskip
\item
